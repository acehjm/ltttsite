                    ...
                    <div className="max-w-4xl mx-auto space-y-16">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid lg:grid-cols-[2fr,1fr] gap-12">
                                    ...
                                    <div className="space-y-6 lg:border-l lg:pl-12 lg:border-white/10">
                                        ...
                                        <InfoItem
                                            icon={
                                                <RocketIcon className="w-5 h-5 text-violet-300" />
                                            }
                        ...
                        <section className="space-y-8">
                            ...
                            <div className="pt-1 space-y-1.5">
                                <div className="text-sm text-zinc-500/70 font-['PixelBody']">
                                    more tags
                                </div>
                        ...
                        <section className="space-y-8">
                            ...
                            <div className="space-y-8">
                                <ExperienceItem
                                    ...
                                    achievements={
                                        t("about.experience_section.jobs.senior.achievements", {
                                            returnObjects: true,
                                        }) as string[]
                                    }
                                />
                                <ExperienceItem
                                    ...
                                    achievements={
                                        t("about.experience_section.jobs.fullstack.achievements", {
                                            returnObjects: true,
                                        }) as string[]
                                    }
                                />
...
function ExperienceItem({
    ...
    return (
        <div className="p-6 rounded-lg bg-white/[0.02] hover:bg-white/[0.04] border border-white/[0.05] backdrop-blur-md transition-all duration-300 group">
            <div className="space-y-4">
                <div className="space-y-1">
                    <h3 className="text-lg font-['PixelFont'] text-zinc-200/90 group-hover:text-violet-300/90 transition-colors duration-300">
                        {title}
                    </h3>
                ...
                {skills.map((skill) => (
                    <div key={skill.name} className="space-y-2.5">
                        <div className="flex justify-between text-sm items-center">
                            <span className={`${textColor[type]} font-['PixelBody']`}>
                                {skill.name}
                            </span>
                            <span
                                className={`${textColor[type]} font-['PixelBody'] text-xs bg-white/5 px-2 py-0.5 rounded-full`}
                            >
                                {skill.level}%
                            </span>
                        </div>
